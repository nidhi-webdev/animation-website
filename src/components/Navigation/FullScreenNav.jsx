...
const FullScreenNav = () => {
    ...
    console.log('FullScreenNav - navOpen state:', navOpen)
    
    if(!navOpen) return null

    return (
        <div id='fullScreenNav' className='text-white h-screen w-full fixed top-0 left-0 bg-black z-50 overflow-hidden'>
            <div className='flex w-full justify-between items-start'>
                ...
                <div 
                    ...
                    className='h-32 w-32  relative cursor-pointer pt-2'>
